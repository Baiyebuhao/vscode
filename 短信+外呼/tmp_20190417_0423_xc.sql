...
create table tmp_20190417_0423_xc
as
...
where a.registe_date between '2019-04-17' and '2019-04-23'                   ---------选择注册时间维度
...
where c.status_desc in('自认证','认证成功') 
  and c.action_date between '2019-04-17' and '2019-04-23') a2
...
where c.apply_time between '2019-04-17' and '2019-04-23'           ---------选择申请时间维度
...
where a2.mbl_no <> 'null'
	...
	and a2.cash_time between '2019-04-17' and '2019-04-23'                       ---------选择提现时间维度 
