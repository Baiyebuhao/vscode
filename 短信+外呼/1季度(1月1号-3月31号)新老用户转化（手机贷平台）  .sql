...
where a1.extractday between '2019-01-01' and '2019-03-31'
and a1.button_name in ('申请','立即申请') 
and a1.sys_id = 'sjd'
-----总推送
and a1.mbl_no in
(select distinct a.mbl_no from warehouse_atomic_user_info a
where a.registe_date between '2019-01-01' and '2019-03-31'
...
where a1.apply_time between '2019-01-01' and '2019-03-31'
...
where a1.cash_time between '2019-01-01' and '2019-03-31'
and a1.data_source = 'sjd'
-----总提现
and a1.mbl_no in
(select distinct a.mbl_no from warehouse_atomic_user_info a
