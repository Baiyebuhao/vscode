...
join (select distinct mbl_no
           ...
           where extractday between '2019-05-26' and '2019-05-28'
           and platform = 'sjd'
           UNION
           select distinct mbl_no
           from warehouse_atomic_user_action b2
           where sys_id = 'sjd'
           and extractday between '2019-05-26' and '2019-05-28') a3 
