create table tmp_20190327_0402_xc2
as
...
where a.registe_date between '2019-03-27' and '2019-04-02'                   ---------选择注册时间维度
...
where c.status_desc in('自认证','认证成功') 
  and c.action_date between '2019-03-27' and '2019-04-02') a2
...
where c.apply_time between '2019-03-27' and '2019-04-02'           ---------选择申请时间维度
...
a1.chan_no_desc,
a1.child_chan
from warehouse_data_withdrawals_info a2
left join 
(select distinct a.mbl_no,
       a.registe_date,
       a.data_source, 
...
where a2.mbl_no <> 'null'
	...
	and a2.cash_time between '2019-03-27' and '2019-04-02'                       ---------选择提现时间维度 
