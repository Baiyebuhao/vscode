...
select distinct a.mbl_no as mbl_no,
       b.age,
       b.sex_desc as sex
...
(SELECT b.age,
       count(DISTINCT b.mbl_no) as mbl_num
from(
SELECT distinct mbl_no,
       age,
       sex
...
where bank_name = '秦皇岛抚宁家银村镇银行'
  and substr(c_date,1,10) between '2020-01-01' and '2020-03-31') b
GROUP BY b.age
)