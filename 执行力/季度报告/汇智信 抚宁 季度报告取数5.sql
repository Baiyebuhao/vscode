...
where a1.id is not null
  ...
  and a1.m_id <> '-1'
  and substr(a1.c_time,1,10) between '2020-01-01' and '2020-04-01'
...
WHERE substr(a.loan_apply_time,1,10) between '2020-01-01' and '2020-04-01'
...
WHERE substr(a.loan_apply_time,1,10) >= '2019-09-01'
  and substr(a.research_apply_time,1,10) between '2020-01-01' and '2020-04-01'
  AND c.name = '秦皇岛抚宁家银村镇银行'
  AND d.name NOT LIKE '%测试%') a
