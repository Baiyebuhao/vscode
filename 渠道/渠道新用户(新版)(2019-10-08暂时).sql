...
where a.registe_date between '2019-11-01' and '2019-11-30'                  ---------选择注册时间维度
...
from warehouse_atomic_time_user a   
     left join warehouse_data_chan_info b 
         ...
         and a.chan_no = b.chan_no 
         and a.child_chan = b.child_chan
where substring(a.registe_date,1,10) between '2019-11-01' and '2019-11-30'                  ---------选择注册时间维度
  and a.data_source = 'jry'
...
from warehouse_atomic_user_info a 
 ...
 where a.registe_date between '2019-11-01' and '2019-11-30'                 ---------选择注册时间维度
   ...
   and c.action_date between '2019-11-01' and '2019-11-30'                  ------------选择实名时间维度
UNION ALL
select '实名' AS code,
       a.data_source, 
       c.action_date AS extractday,
...
where a.registe_date between '2019-11-01' and '2019-11-30'              ---------选择注册时间维度
  and a.data_source <> 'jry'
  and c.apply_time between '2019-11-01' and '2019-11-30'                ---------选择申请时间维度
UNION ALL
select '申请' AS code,
       a.data_source,
       c.apply_time AS extractday,
...
where a.registe_date between '2019-11-01' and '2019-11-30'              ---------选择注册时间维度
  and a.data_source <> 'jry'
  and c.credit_time between '2019-11-01' and '2019-11-30'                ---------选择授信时间维度
  and c.status = '通过'
UNION ALL
select '授信' AS code,
       a.data_source,
...
where a.registe_date between '2019-11-01' and '2019-11-30'              ---------选择注册时间维度
  and a.data_source <> 'jry'
  and c.cash_time between '2019-11-01' and '2019-11-30'                ---------选择提现时间维度
  and c.cash_amount > 0
UNION ALL
select '提现' AS code,
       a.data_source,
