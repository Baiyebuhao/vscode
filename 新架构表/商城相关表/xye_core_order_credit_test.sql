--重构数据库PDM_xye_core_order_credit_test-2020.01.09
--订单，申请，授信，提现
(drop table if exists xye_core_order_credit_test.credit_apply_info;
...
(drop table if exists xye_core_order_credit_test.credit_core_order;
...
(drop table if exists xye_core_order_credit_test.credit_core_order_copy;

/*==============================================================*/
/* Table: credit_core_order_copy                                */
/*==============================================================*/
create table xye_core_order_credit_test.credit_core_order_copy
(
   id                   varchar(36) not null comment 'id',
   order_code           varchar(50) comment '订单号',
   product_type         varchar(50) comment '产品类型（随借随还，现金分期）',
...
alter table xye_core_order_credit_test.credit_core_order_copy comment '信贷订单';
)
...
(drop table if exists xye_core_order_credit_test.credit_order_status_dict;
...
(drop table if exists xye_core_order_credit_test.credit_order_status_dict_copy;

/*==============================================================*/
/* Table: credit_order_status_dict_copy                         */
/*==============================================================*/
create table xye_core_order_credit_test.credit_order_status_dict_copy
(
   id                   varchar(50) not null,
   status_type          varchar(50),
   status_code          varchar(50),
