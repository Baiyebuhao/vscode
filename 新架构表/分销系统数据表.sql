...
(/*==============================================================*/
/* Table: distribution_plan_info          分销计划              */
/*==============================================================*/
...
/*==============================================================*/
/* Table: distribution_plan_apply            分销计划申请       */
/*==============================================================*/
...
(
   ...
   amount_or_proportion varchar(100) comment '分销金额比例',
   status               int(2) default 0 comment '状态（0:待审核 1：审核通过 2：审核驳回）',
   comments             varchar(255) comment '备注',
   create_date          datetime comment '创建时间',
   create_by            varchar(30) comment '创建人',
   update_date          datetime comment '修改时间',
...
/*==============================================================*/
/* Table: con_plan_merchant   分销计划与分销商关系表            */
/*==============================================================*/
...
/*==============================================================*/
/* Table: cash_out_apply_info       提现申请表                  */
/*==============================================================*/
...
/*==============================================================*/
/* Table: register_invitation_configure    注册邀请配置         */
/*==============================================================*/
...
/*==============================================================*/
/* Table: distribution_wallet_info        分销用户钱包          */
/*==============================================================*/
...
/*==============================================================*/
/* Table: recommend_goods_info      注册邀请优质产品列表        */
/*==============================================================*/
