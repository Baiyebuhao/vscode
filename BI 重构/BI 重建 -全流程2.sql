...
SELECT '注册' as code,
       ...
       a1.chan_no as channel_code,         ---渠道号
           ...
           case when a3.promoter_name is NULL then a1.chan_no_desc 
                else a3.promoter_name end promoter_name,   --渠道名称
...
LEFT JOIN warehouse_all_platform_mall_info a2
 on a1.app_code=a2.mall_code
LEFT JOIN warehouse_jry_business_promoter a3
 on a1.chan_no = a3.promoter_code
and a2.mall_code = a3.general_code
...
select '申请' as code,
	   ...
	   a4.promoter_name, --渠道名称
       a4.promoter_type, --渠道类型
...
LEFT JOIN warehouse_all_platform_mall_info a3
 on a2.mall_code=a3.mall_code     --商城号   a2.mall_code=a3.mall_code 
LEFT JOIN warehouse_jry_business_promoter a4 
 on a2.channel_code = a4.promoter_code   --渠道号  a2.channel_code = a4.promoter_code   --渠道号
and a3.mall_code = a4.general_code
union all
--授信
select '授信' as code,
       a1.data_source as data_source,
