...
join warehouse_atomic_user_info a4
  on a4.mbl_no = a1.mbl_no
 and a4.chan_no = a3.promoter_code
 and a4.app_code=a3.mall_code
 and substring(a4.registe_date,1,10) = substring(a1.apply_time,1,10)
...
join warehouse_atomic_user_info a4
 ...
 and a4.chan_no = a3.promoter_code
 and a4.app_code=a3.mall_code
 and substring(a4.registe_date,1,10) = substring(a1.credit_time,1,10)
...
join warehouse_atomic_user_info a4
 ...
 and a4.chan_no = a3.promoter_code
 and a4.app_code=a3.mall_code
 and substring(a4.registe_date,1,10) = substring(a1.loan_time,1,10)
