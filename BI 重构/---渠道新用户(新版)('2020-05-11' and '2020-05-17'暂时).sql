---渠道新用户(新版)('2020-06-15' and '2020-06-21'暂时)(BI重构）
SELECT data_source,
       the_2nd_level,
       the_3rd_level,
       chan_no,
...
where a.registe_date between '2020-06-15' and '2020-06-21'                   ---------选择注册时间维度
...
where substring(a.registe_date,1,10) between '2020-06-15' and '2020-06-21'                  ---------选择注册时间维度
...
where a.registe_date between '2020-06-15' and '2020-06-21'               ---------选择注册时间维度
  and a.data_source in ('sjd','xyqb')
  and c.apply_time between '2020-06-15' and '2020-06-21'                 ---------选择申请时间维度
...
where a.registe_date between '2020-06-15' and '2020-06-21'               ---------选择注册时间维度
  and a.data_source in ('sjd','xyqb')
  and c.credit_time between '2020-06-15' and '2020-06-21'                 ---------选择授信时间维度
  and c.status = '通过'
...
where a.registe_date between '2020-06-15' and '2020-06-21'               ---------选择注册时间维度
  and a.data_source in ('sjd','xyqb')
  and c.cash_time between '2020-06-15' and '2020-06-21'                 ---------选择提现时间维度
  and c.cash_amount > 0
